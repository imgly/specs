Pod::Spec.new do |s|
  ...
  s.swift_version       = '5.1'
  s.version             = '10.0.1-xcode.11.0.beta.6'
  ...
  s.preserve_paths      = 'PhotoEditorSDK/ImglyKit.framework', 'PhotoEditorSDK/ImglyKit.framework.dSYM', 'PhotoEditorSDK/PhotoEditorSDK.framework', 'PhotoEditorSDK/PhotoEditorSDK.framework.dSYM'
  s.public_header_files = 'PhotoEditorSDK/ImglyKit.framework/Headers/*.h', 'PhotoEditorSDK/PhotoEditorSDK.framework/Headers/*.h'
  s.source_files        = 'PhotoEditorSDK/ImglyKit.framework/Headers/*.h', 'PhotoEditorSDK/PhotoEditorSDK.framework/Headers/*.h'
  s.vendored_frameworks = 'PhotoEditorSDK/ImglyKit.framework', 'PhotoEditorSDK/PhotoEditorSDK.framework'
